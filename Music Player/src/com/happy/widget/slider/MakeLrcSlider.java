...
class MSliderUI extends BasicSliderUI {
	...
	g2d.fillOval(thumbRect.x, thumbRect.y + 1, thumbRect.width, thumbRect.height - 8);
    }
	...
	if (slider.getOrientation() == JSlider.HORIZONTAL) {
	    ...
	    // 背景颜色
	    g2.setPaint(new GradientPaint(0, -cy + 5, new Color(154, 187, 209, 255), 0, cy, new Color(255, 255, 255),
		    true));
