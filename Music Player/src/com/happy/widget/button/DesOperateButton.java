...
public class DesOperateButton extends JButton {
   ...
   //桌面窗口事件
    ...
    public DesOperateButton(String baseIconPath, String overIconPath, String pressedIconPath, int width, int height,
	    MouseInputListener desLrcDialogMouseListener, DesOperatePanel desOperatePanel) {
	ImageIcon icon = new ImageIcon(baseIconPath);
	icon.setImage(icon.getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH));
	this.setIcon(icon);
	ImageIcon rolloverIcon = new ImageIcon(overIconPath);
	rolloverIcon.setImage(rolloverIcon.getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH));
	this.setRolloverIcon(rolloverIcon);
	ImageIcon pressedIcon = new ImageIcon(pressedIconPath);
	pressedIcon.setImage(pressedIcon.getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH));
    ...
    public DesOperateButton(String baseIconPath, String overIconPath, String pressedIconPath, int width, int height,
	    MouseInputListener desLrcDialogMouseListener, DesOperatePanel desOperatePanel, boolean isHide) {
	this.isHide = isHide;
	ImageIcon icon = new ImageIcon(baseIconPath);
	icon.setImage(icon.getImage().getScaledInstance(width, height, Image.SCALE_SMOOTH));
	this.setIcon(icon);
    ...
    public DesOperateButton(String baseIconPath, int width, int height, MouseInputListener desLrcDialogMouseListener,
