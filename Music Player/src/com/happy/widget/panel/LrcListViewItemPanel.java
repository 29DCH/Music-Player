...
public class LrcListViewItemPanel extends JPanel {
    ...
    public LrcListViewItemPanel(int lyricsLineNum, KscLyricsLineInfo kscLyricsLineInfo,
	...
	lrcComPanel = new LrcComPanel(lyricsLineNum, comPanel, makeLrcZhiZuoPanel, kscLyricsLineInfo, lWidth, bHeight);
