...
public class TrayLockPanel extends JPanel {
	...
	String eliPath = Constants.PATH_ICON + File.separator + "trayLock_enter.png";
	ImageIcon eliPathIcon = new ImageIcon(eliPath);
	eliPathIcon.setImage(eliPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	enterLockedIcon = new JLabel(eliPathIcon);
	enterLockedIcon.setBounds(5, 0, height, height);
	String exliPath = Constants.PATH_ICON + File.separator + "trayLock_def.png";
	ImageIcon exliPathIcon = new ImageIcon(exliPath);
	exliPathIcon.setImage(exliPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	exitLockedIcon = new JLabel(exliPathIcon);
	exitLockedIcon.setBounds(5, 0, height, height);
	String euliPath = Constants.PATH_ICON + File.separator + "trayUnLock_enter.png";
	ImageIcon euliPathIcon = new ImageIcon(euliPath);
	euliPathIcon.setImage(euliPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	enterUnLockIcon = new JLabel(euliPathIcon);
	enterUnLockIcon.setBounds(5, 0, height, height);
	String exitliPath = Constants.PATH_ICON + File.separator + "trayUnLock_def.png";
	ImageIcon exitliPathIcon = new ImageIcon(exitliPath);
	exitliPathIcon.setImage(exitliPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	exitUnLockIcon = new JLabel(exitliPathIcon);
	exitUnLockIcon.setBounds(5, 0, height, height);
	String dislPath = Constants.PATH_ICON + File.separator + "trayDisLocked.png";
	ImageIcon dislPathIcon = new ImageIcon(dislPath);
	dislPathIcon.setImage(dislPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	disLockedIcon = new JLabel(dislPathIcon);
	disLockedIcon.setBounds(5, 0, height, height);
	String disulPath = Constants.PATH_ICON + File.separator + "trayDisUnLock.png";
	ImageIcon disulPathIcon = new ImageIcon(disulPath);
	disulPathIcon.setImage(disulPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
