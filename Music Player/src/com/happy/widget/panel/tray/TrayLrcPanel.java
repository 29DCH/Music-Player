...
public class TrayLrcPanel extends JPanel {
    ...
    public TrayLrcPanel(int width, int height, TrayEvent trayEvent, MouseInputListener dialogMouseListener,
	...
	//
	String enterPath = Constants.PATH_ICON + File.separator + "trayLrc_enter.png";
	ImageIcon enterPathIcon = new ImageIcon(enterPath);
	enterPathIcon.setImage(enterPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
	enterLrcIcon = new JLabel(enterPathIcon);
	enterLrcIcon.setBounds(5, 0, height, height);

	//

	String exitPath = Constants.PATH_ICON + File.separator + "trayLrc_def.png";
	ImageIcon exitPathIcon = new ImageIcon(exitPath);
	exitPathIcon.setImage(exitPathIcon.getImage().getScaledInstance(height, height, Image.SCALE_SMOOTH));
