...
public class DesOperateLabel extends JLabel implements Observer {
    ...
    public DesOperateLabel(int width, int height, MouseInputListener desLrcDialogMouseListener,
	...
	backgroundPath = Constants.PATH_BACKGROUND + File.separator + Constants.backGroundName;
    }
