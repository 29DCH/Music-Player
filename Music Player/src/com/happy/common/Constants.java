...
public class Constants {
    ...
    // 目录数据
    // 临时目录,保存在haplayer中
    public final static String PATH_TEMP = "haplayer";// 跨平台,与系统有关的默认名称分隔符
    // Logcat日志目录
    ...
    // 歌词目录
    public final static String PATH_lyrics = PATH_TEMP + File.separator + "music_lyrics";
    // 歌词目录
    ...
    // 播放歌曲列表数据
    public final static String PATH_PLAYLISTDATA = PATH_DATA + File.separator + "playdata";

    // 窗口背景图片
    public final static String PATH_BACKGROUND = PATH_TEMP + File.separator + "background";
    // 图标
    ...
    // 皮肤
    public final static String PATH_SPLASH = PATH_TEMP + File.separator + "splash";
    // 基本数据
    // 应用名
    public final static String APPNAME = "HPSZ";
    // 标题
    public final static String APPTITLE = "音乐";
    // 提示语
    public final static String APPTIPTITLE = "";
    // 字体大小
    public final static int APPFONTSIZE = 16;
    // 歌曲播放模式
    public static int playModel = 2; // 0是顺序播放 1是随机播放 2是循环播放 3是单曲播放 4单曲循环
    // 歌曲播放模式key
    ...
    // 桌面背景图片
    public static String backGroundName = "11.jpg";
    // 桌面背景图片key
    ...
    // 歌词颜色集合
    public static Color[] lrcColorStr = { new Color(138, 1, 226), new Color(250, 218, 131), new Color(225, 125, 179),
	    new Color(157, 196, 0) };
    // 歌词最小大小
    ...
    // 未读歌词颜色
    public static Color DESLRCNOREADCOLORFRIST[] = { new Color(0, 52, 138), new Color(255, 255, 255),
	    new Color(255, 172, 0), new Color(225, 225, 225), new Color(64, 0, 128) };

    public static Color DESLRCNOREADCOLORSECOND[] = { new Color(3, 202, 252), new Color(76, 166, 244),
	    new Color(170, 0, 0), new Color(0, 0, 0), new Color(255, 128, 255) };
    // 已读歌词颜色
    public static Color DESLRCREADEDCOLORFRIST[] = { new Color(130, 247, 253), new Color(255, 100, 26),
	    new Color(255, 255, 0), new Color(0, 255, 255), new Color(255, 243, 146) };

    public static Color DESLRCREADEDCOLORSECOND[] = { new Color(255, 255, 255), new Color(255, 255, 255),
	    new Color(255, 100, 26), new Color(255, 255, 255), new Color(255, 243, 134) };
    // 桌面歌词颜色
