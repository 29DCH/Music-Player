...
public class MainLrcOperateButton extends JButton {
    ...
    public MainLrcOperateButton(String baseIconPath, String overIconPath, String pressedIconPath, int width, int height,
	    MouseInputListener mainLrcOPMouseListener, MainLrcOperatePanel mainLrcOperatePanel, boolean scale,
