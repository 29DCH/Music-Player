...
public class DesLrcColorParentPanel extends JPanel {
     ...
     * @param lrcEvent
     */
    public DesLrcColorParentPanel(int width, int height, Color color, MouseInputListener desLrcDialogMouseListener,
	...
	this.setLayout(null);
	//
	desLrcColorPanel = new DesLrcColorPanel(width / 3 * 2, width / 3 * 2, color, desLrcDialogMouseListener,
		desOperatePanel, index, lrcEvent);
