...
public class ListViewItemComItemPanel extends JPanel {
	...
	delButton.setBounds(songSize.getX() - (defHeight / 2 + 10), (defHeight - defHeight / 2) / 2, defHeight / 2 + 5,
		defHeight / 2);
	...
	delButton.setBounds(songSize.getX() - (defHeight / 2 + 10), height / 2 + (defHeight - defHeight / 2) / 2 - 2,
		defHeight / 2 + 5, defHeight / 2);
	delButton.setToolTipText("删除");
