...
public class LrcColorParentPanel extends JPanel {
     ...
     * @param lrcEvent
     */
    public LrcColorParentPanel(int width, int height, Color color, MouseInputListener mainLrcOPMouseListener,
	    MainLrcOperatePanel mainLrcOperatePanel, int index, LrcEvent lrcEvent) {
	...
	this.setLayout(null);
	//
	lrcColorPanel = new LrcColorPanel(width / 3 * 2, width / 3 * 2, color, mainLrcOPMouseListener,
		mainLrcOperatePanel, index, lrcEvent);
	...
	String statusIconFilePath = Constants.PATH_ICON + File.separator + "skin_selected_bg_tip.png";
	int sWidth = width / 3 * 2 / 2;
	int sHeight = width / 3 * 2 / 2;
	jstatusLabel = new JLabel(getBackgroundImageIcon(sWidth, sHeight, statusIconFilePath));
