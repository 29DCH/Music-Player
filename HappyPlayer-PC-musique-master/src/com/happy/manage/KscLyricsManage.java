...
public class KscLyricsManage {
     ...
     */
    public static KscLyricsParserUtil getKscLyricsParser(String sid, String kscFilePath) {
	if (sid.equals(mSid)) {
    ...
    public static KscLyricsParserUtil getKscLyricsParserByKscInputStream(String sid) {
	if (sid.equals(mSid)) {
	    if (mKscLyricsParser == null) {
     ...
     */
    public static void parserKscLyricsByKscInputStream(String sid, InputStream kscInputStream, int type)
